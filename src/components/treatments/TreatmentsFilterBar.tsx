...
export default function TreatmentsFilterBar({
  ...
  return (
    <motion.section
      className="sticky top-[72px] z-40 bg-surface/80 backdrop-blur-md px-12 py-8 mb-16"
            ...
            {filters.map((filter) => {
              ...
              return (
                <motion.button
                  ...
                  className={`relative text-xs tracking-widest uppercase pb-2 transition-colors duration-300 ${
                    isActive
