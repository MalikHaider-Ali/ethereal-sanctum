...
const credentials = [
  {
    ...
    sub: "International Medical Acc.",
  },
  {
    icon: "clinical_notes",
    title: "Clinical Excellence",
    sub: "Holistic Health Institute",
  },
  {
    icon: "award_star",
    title: "Five Star Sanctuary",
    sub: "Global Spa Association",
  },
  {
    icon: "ecg_heart",
    title: "Ethical Practice",
    sub: "Certified B-Corp Medical",
  },
];

// Badge tilts + inner glow follows cursor
function CredentialBadge({
  ...
  return (
    ...
    >
      {/* Floating circle with pointer glow */}
      <motion.div
        className="w-20 h-20 rounded-full border border-primary/30 bg-surface-container-lowest flex items-center justify-center text-primary relative overflow-hidden"
      ...
      <div>
        <h4 className="font-label text-[10px] uppercase tracking-[0.3em] text-primary">
          {title}
        </h4>
  ...
  return (
    <section className="py-24 bg-surface-container-low overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-4 relative z-10">
          {credentials.map((c, i) => (
