...
const steps = [
  {
    number: "01",
    title: "Consultation",
    desc: "A deep-dive analysis of your skin's genetic profile and personal aspirations.",
  },
  {
    number: "02",
    title: "Curated Plan",
    desc: "A bespoke sequence of clinical treatments and holistic home rituals.",
  },
  {
    number: "03",
    title: "Transformation",
    desc: "The unveiling of your most vibrant self through expert-led precision.",
  },
];

export default function ProcessSection() {
  return (
    <section className="py-32 px-12 bg-surface-container-lowest overflow-hidden">
      <motion.div
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="aspect-square bg-surface-container-high rounded-full flex items-center justify-center relative overflow-hidden">
                ...
                />
                <motion.span
                  className="text-6xl font-headline text-outline-variant group-hover:text-primary transition-colors duration-700 relative z-10"
              ...
              <div className="text-center space-y-4">
                <h3 className="font-headline text-2xl text-on-background italic">
                  {step.title}
                </h3>
